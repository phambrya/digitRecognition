...
def predict_digit(img):
    ...
    img = img.convert('L')
    #issue here: Cause the image is inverted, the black is white and the white is black, in the training data the writing is white, but in testing
    #with real hand writing it is black.
